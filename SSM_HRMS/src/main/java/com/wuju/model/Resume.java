...
public class Resume {
    ...
    public Resume(Integer rId) {
        this.rId = rId;
    }

    public Resume(String rName, String rSex, Date rBirthday, Date rWorktime, String rSchool, String rEducation, String rMajor, Date rAdmission, Date rGraduation, String rSchoolexp, String rCompany, String rJob, String rAbility, Date rEntry, Date rQuit, String rHopejob, double rSalary, String rIndustry, String rLocation, String rFeature, User user) {
        this.rName = rName;
        this.rSex = rSex;
